...
() {
  return (
    <div className='w-full h-full ' id='services'>
      {/* container */}
      <div className='w-full  flex flex-col items-center px-[100px] pt-[50px]'>
        {/* header */}
        <div className='flex flex-col gap-6 items-center mb-[50px]'>
          <h6 className='text-lightBlue texl-xl font-semibold'>OUR SERVICES</h6>
          <h1 className='text-[60px] text-center text-white font-bold w-[668px] leading-[70px]'>Discover Luxury in WebHosting</h1>
        </div>
        {/* header end */}

        {/* cards */}
        <div className='flex flex-col items-center gap-6 mb-[200px]'>
          {/* row */}
        ...
        <div className='w-full h-full flex gap-8 items-center'>
          ...
          <div className='flex flex-col gap-3'>
            <div className='bg-second w-[476px] h-[130px] flex items-center pl-10 gap-8'>
          ...
          <div className='w-full flex flex-col'>
            <div className='flex flex-col gap-3 mb-10'>
              ...
              <h1 className='text-[50px] text-white font-bold w-[715px] leading-[70px]'>From Skyline to the Shoreline, We Are There</h1>
              <p className='text-lightGray text-base font-medium w-[715px] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras consectetur adipiscing Quisque et imperdiet ipsum. Nunc molestie nunc ac augue sodales luctus..</p>
            </div>
            {/* grid */}
            ...
            {/* grid end */}
            {/* cta */}
            <button className='w-[186px] h-[78px] bg-btnColor text-xl font-semibold text-white hover:text-darkBlue transition duration-300'>More Detail</button>
          </div>
